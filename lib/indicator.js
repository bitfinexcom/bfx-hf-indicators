...
const prepareTradingViewIndicatorConfig = require('./utils/prepare_tradingview_indicator_config')

const ALLOWED_TYPES = ['line', 'lines', 'rsi']

class Indicator {
  static getTradingViewConfig (args) {
    if (_includes(ALLOWED_TYPES, this.ui.type)) {
      return prepareTradingViewIndicatorConfig({
        ...args,
