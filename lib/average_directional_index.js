...
class ADX extends Indicator {
  ...
  static calcUpdate (candle = {}, lastCandle = {}, indicators = {}, type) {
    ...
    const dmUp = upMove > downMove && upMove > 0 ? upMove : 0

    const dmDown = downMove > upMove && downMove > 0 ? downMove : 0
...
ADX.getTradingViewConfig = function (args) {
  return getSinglePlotIndicator({
    ...args,
    IndicatorConstructor: ADX
  })
}
