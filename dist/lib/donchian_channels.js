...
var DC = /*#__PURE__*/function (_Indicator) {
  _inherits(DC, _Indicator);
  ...
  _createClass(DC, [{
    ...
    value: function reset() {
      _get(_getPrototypeOf(DC.prototype), "reset", this).call(this);
      this._buffer = [];
    }
  }, {
    key: "update",
    value: function update(candle) {
      ...
      var max = _max(this._buffer.map(function (c) {
        return c.high;
      }));
      var min = _min(this._buffer.map(function (c) {
        return c.low;
      }));
      return _get(_getPrototypeOf(DC.prototype), "update", this).call(this, {
        upper: max,
        middle: (max + min) / 2,
        lower: min
      });
    ...
    value: function add(candle) {
      ...
      return _get(_getPrototypeOf(DC.prototype), "add", this).call(this, {
        upper: max,
        middle: (max + min) / 2,
        lower: min
      });
