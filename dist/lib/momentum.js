...
var Momentum = /*#__PURE__*/function (_Indicator) {
  _inherits(Momentum, _Indicator);
  ...
  _createClass(Momentum, [{
    ...
    value: function update(value) {
      ...
      return _get(_getPrototypeOf(Momentum.prototype), "update", this).call(this, value - this._buffer[0]);
    }
  }, {
    key: "add",
    value: function add(value) {
      if (this._buffer.length === this._p) {
        _get(_getPrototypeOf(Momentum.prototype), "add", this).call(this, value - this._buffer[0]);
      }
      this._buffer.push(value);
      if (this._buffer.length > this._p) {
...
Momentum.getTradingViewConfig = function (args) {
  return getSinglePlotIndicator(_objectSpread(_objectSpread({}, args), {}, {
    IndicatorConstructor: Momentum
  }));
};
