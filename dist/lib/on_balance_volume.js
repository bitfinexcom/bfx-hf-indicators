...
var OBV = /*#__PURE__*/function (_Indicator) {
  _inherits(OBV, _Indicator);

  var _super = _createSuper(OBV);
  ...
  _createClass(OBV, [{
    ...
    value: function reset() {
      _get(_getPrototypeOf(OBV.prototype), "reset", this).call(this);
    ...
    value: function update(candle) {
      ...
      return _get(_getPrototypeOf(OBV.prototype), "update", this).call(this, obv);
    }
  }, {
    key: "add",
    value: function add(candle) {
      ...
      _get(_getPrototypeOf(OBV.prototype), "add", this).call(this, obv);
