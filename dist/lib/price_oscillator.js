...
var PPO = /*#__PURE__*/function (_Indicator) {
  _inherits(PPO, _Indicator);
  var _super = _createSuper(PPO);
  function PPO() {
    var _this;
    var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    _classCallCheck(this, PPO);
    ...
    _this = _super.call(this, {
      args: args,
      id: PPO.id,
      name: "PPO(".concat(shortPeriod, ", ").concat(longPeriod, ")"),
      seedPeriod: longPeriod
    });
    _this._shortEMA = new EMA([shortPeriod]);
    _this._longEMA = new EMA([longPeriod]);
    _this._signalEMA = new EMA([9]);
    return _this;
  }
  _createClass(PPO, [{
    key: "reset",
    value: function reset() {
      _get(_getPrototypeOf(PPO.prototype), "reset", this).call(this);
    ...
    value: function update(v) {
      ...
      var ppo = _long === 0 ? 0 : (_short - _long) / _long * 100;
      this._signalEMA.update(ppo);
      return _get(_getPrototypeOf(PPO.prototype), "update", this).call(this, this._signalEMA.v());
    }
  }, {
    key: "add",
    value: function add(v) {
      ...
      var ppo = _long2 === 0 ? 0 : (_short2 - _long2) / _long2 * 100;
      this._signalEMA.add(ppo);
      return _get(_getPrototypeOf(PPO.prototype), "add", this).call(this, this._signalEMA.v());
    }
  }], [{
    key: "unserialize",
...
PPO.getTradingViewConfig = function (args) {
  return getSinglePlotIndicator(_objectSpread(_objectSpread({}, args), {}, {
    IndicatorConstructor: PPO
  }));
};
module.exports = PPO;