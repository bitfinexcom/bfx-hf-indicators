...
var Aroon = /*#__PURE__*/function (_Indicator) {
  _inherits(Aroon, _Indicator);

  var _super = _createSuper(Aroon);
  ...
  _createClass(Aroon, [{
    ...
    value: function reset() {
      _get(_getPrototypeOf(Aroon.prototype), "reset", this).call(this);
    ...
    value: function update(value) {
      ...
      var daysSinceMax = this._buffer.length - _findIndex(this._buffer, function (v) {
        return v === max;
      });

      var daysSinceMin = this._buffer.length - _findIndex(this._buffer, function (v) {
        return v === min;
      });

      return _get(_getPrototypeOf(Aroon.prototype), "update", this).call(this, {
    ...
    value: function add(value) {
      ...
      return _get(_getPrototypeOf(Aroon.prototype), "add", this).call(this, {
        up: (this._p - daysSinceMax) / this._p * 100,
        down: (this._p - daysSinceMin) / this._p * 100
      });
    }
    ...
    value: function avg() {
      ...
      return {
        up: _sum(this.nValues(n).map(function (v) {
          return v.up;
        })) / n,
        down: _sum(this.nValues(n).map(function (v) {
          return v.down;
        })) / n
      };
    }
